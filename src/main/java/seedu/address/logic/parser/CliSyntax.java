...
public class CliSyntax {
    ...
    public static final Prefix PREFIX_DOCTOR_ID = new Prefix("id/");
    ...
    public static final Prefix PREFIX_NEWDOC = new Prefix("nid/");
    public static final Prefix PREFIX_APPT_ID = new Prefix("apptid/");
