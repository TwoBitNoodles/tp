...
public class EditDocCommandParserTest {

    private static final String MESSAGE_INVALID_FORMAT =
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, EditDocCommand.MESSAGE_USAGE);

    private EditDocCommandParser parser = new EditDocCommandParser();
    ...
    public void parse_missingParts_failure() {
        ...
        // no field specified
        assertParseFailure(parser, "1", EditDocCommand.MESSAGE_NOT_EDITED);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditDoctorDescriptor descriptor = new EditDoctorDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .build();
        EditDocCommand expectedCommand = new EditDocCommand(targetIndex, descriptor);
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        expectedCommand = new EditDocCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
