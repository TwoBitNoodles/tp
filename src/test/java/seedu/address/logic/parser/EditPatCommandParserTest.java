...
public class EditPatCommandParserTest {
    ...
    public void parse_invalidPreamble_failure() {
        // negative index
        assertParseFailure(parser, "-5" + NAME_DESC_AMY, MESSAGE_INVALID_PATIENT_DISPLAYED_INDEX);

        // zero index
        assertParseFailure(parser, "0" + NAME_DESC_AMY, MESSAGE_INVALID_PATIENT_DISPLAYED_INDEX);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditPatCommand.EditPatDescriptor descriptor = new EditPatientDescriptorBuilder().withName(VALID_NAME_AMY)
            .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
            .build();
        EditPatCommand expectedCommand = new EditPatCommand(targetIndex, descriptor);
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        EditPatCommand.EditPatDescriptor descriptor = new EditPatientDescriptorBuilder().withPhone(VALID_PHONE_BOB)
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        expectedCommand = new EditPatCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
